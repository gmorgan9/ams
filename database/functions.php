...
if (empty($section)) {
  ...
  if (count($errors) == 0) {
      ...
      $query = "INSERT INTO course (course, title, taken, day, time, location, instructor, credits, mode, section) 
                VALUES('$course', '$title', '$taken', '$day', '$time', '$location', '$instructor', '$credits', '$mode', '$section')";
      mysqli_query($conn, $query);
