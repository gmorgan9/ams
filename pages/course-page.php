  ...
  <tbody>
      ...
      if($result) {
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            <?php } ?>
            <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addScore">
...
<!-- Add Score Modal -->
<div class="modal fade" id="addScore" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
