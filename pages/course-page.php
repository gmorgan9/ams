  ...
  <tbody>
      ...
      if($result) {
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            <td><a data-toggle="modal" data-target="#updateModal" class="edit-btn me-3 me-lg-0" href="/pages/assignment-update.php?uid=<?php echo $id; ?>"><i class="fas fa-pencil"></i> </a></td>
