...
<div class="main">
<a class="me-3 me-lg-0" style="float: right; margin-right: 10px; margin-left: -20px; color: #5C5B5B; font-size: 12px; text-decorations: none;" href="../action/courses/add-course.php"><i class="fas fa-plus"></i></a>Add Course
